...
#SBATCH --output=./slurm-llama-2_all_parallel_fix_failed_run-%A_%a.out

# Location for stderr log - see https://slurm.schedmd.com/sbatch.html#lbAH
#SBATCH --error=./slurm-llama-2_all_parallel_fix_failed_run-%A_%a.out
...
COMMAND="./run-llama-2_all_parallel_fix_failed_run.sh"

...
#SBATCH --time=6-5:30:0

# Location for stdout log - see https://slurm.schedmd.com/sbatch.html#lbAH
#SBATCH --output=./slurm-llama-2_to_en_first_part_fix-%A_%a.out

# Location for stderr log - see https://slurm.schedmd.com/sbatch.html#lbAH
#SBATCH --error=./slurm-llama-2_to_en_first_part_fix-%A_%a.out
...
COMMAND="./run-llama-2_to_en_first_part_fix.sh"

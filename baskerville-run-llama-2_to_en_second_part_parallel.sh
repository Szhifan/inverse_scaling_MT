...
#SBATCH --output=./slurm-llama-2_to_en_second_part_parallel-%A_%a.out

# Location for stderr log - see https://slurm.schedmd.com/sbatch.html#lbAH
#SBATCH --error=./slurm-llama-2_to_en_second_part_parallel-%A_%a.out
...
COMMAND="./run-llama-2_to_en_second_part_parallel.sh"
